    ...
    <div className="container mx-auto mt-10">
      ...
      <div className="mt-[10rem] flex justify-around items-center flex-wrap">
        <form onSubmit={submitHandler} className="w-[40rem]">
          <h1 className="text-2xl font-semibold mb-4">Giao hàng</h1>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block  mb-2">Mã Bưu Chính</label>
            <input
              type="text"
              className="w-full p-2 border rounded"
          ...
          <div className="mb-4">
            <label className="block text-gray-400">Chọn phương thức</label>
            <div className="mt-2">
